...
public class CountDownView extends LinearLayout {
    ...
    private int hh = 0, mm = 0, ss = 0 , dd = 0;
    private Drawable setDrawable;
    private Drawable setDrawable_sub;
    private TextView tv_h, tv_s, tv_m, tv_colon, tv_colon2 ,tv_d,tv_colon3,tv_colon4;
    ...
    class getNetTime extends AsyncTask<Long, Void, Long> {
        ...
        protected Long doInBackground(Long... longs) {
            ...
            try {
                ...
                uc.connect();
                time_net = uc.getDate();
                return longs[0] - time_net - 57594000 + 34450 + 3180 ;
            } catch (Exception e) {
    ...
    public void CreatView() {
        ...
        tv_d = new TextView(mContext);
        tv_colon3 = new TextView(mContext);
        tv_colon4 = new TextView(mContext);

        tv_colon3.setText("天");
        tv_colon.setText("时");
        tv_colon2.setText("分");
        tv_colon4.setText("秒");
        textViews2 = new TextView[]{tv_s, tv_m, tv_h,tv_d};
        textViews = new TextView[]{tv_s, tv_m, tv_h,tv_d};//, tv_colon, tv_colon2,tv_colon3
        ...
        ll.addView(tv_d);
        ll.addView(tv_colon3);
        ll.addView(tv_h);
        ll.addView(tv_colon);
        ll.addView(tv_m);
        ll.addView(tv_colon2);
        ll.addView(tv_s);
        ll.addView(tv_colon4);
        addView(ll);
    }
}
